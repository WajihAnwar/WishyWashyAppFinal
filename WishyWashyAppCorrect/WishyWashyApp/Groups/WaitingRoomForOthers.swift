//
//  WaitingRoomForOthers.swift
//  WishyWashyApp
//
//  Created by Wajih Anwar on 4/26/24.
//

import SwiftUI

struct WaitingRoomForOthers: View {
        var body: some View {
            VStack {
                HStack(spacing:25){
                ...
                Button(action: {
                    ...
                    Text("Waiting for Leader to begin")
